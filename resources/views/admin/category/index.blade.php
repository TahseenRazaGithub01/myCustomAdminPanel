              ...
              <div class="email-side-nav remain-height ov-h">
                <div class="h-100 layers">
                  <div class="p-20 bgc-grey-100 layer w-100">
                    <a href="{{ route('admin.category.listing') }}" class="btn btn-danger btn-block">View Categories</a>
                  </div>
              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.category.store') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      ...
                      <div class="form-group">
                        <input type="file" required="required" class="form-control" id="category_image" name="category_image"
