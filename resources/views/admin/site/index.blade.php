                  ...
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.site.store') }}" enctype="multipart/form-data" class="email-compose-body">
                      ...
                      <div class="send-header">
                        ...
                        <div class="form-group">
                          <input type="text" class='form-control' name="footer_text" placeholder="Copyright @ design code 2019">
                        </div>

                        <div class="form-group">
                          <input type="text" class='form-control' name="footer_email" placeholder="info@designcode.com">
                        </div>

                        <div class="form-group">
                          <input type="text" class='form-control' name="facebook_link" placeholder="https://facebook.com/designcode">
                        </div>

                        <div class="form-group">
                          <input type="text" class='form-control' name="linkedin_link" placeholder="https://linkeding.com/designcode">
                        </div>

                        <div class="form-group">
                          <input type="text" class='form-control' name="youtube_link" placeholder="https://youtube.com/designcode">
                        </div>

                        <div class="form-group">
                          <input type="text" class='form-control' name="google_plus_link" placeholder="https://googleplus.com/designcode">
                        </div>
