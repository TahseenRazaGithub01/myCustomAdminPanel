              ...
              <div class="email-side-nav remain-height ov-h">
                <div class="h-100 layers">
                  <div class="p-20 bgc-grey-100 layer w-100">
                    <a href="{{ route('admin.blog.listing') }}" class="btn btn-danger btn-block">View Blog Listing</a>
                  </div>
              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.blog.update') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      
                      <input type="hidden" name="id" value="{{ $record->id }}">
                      <h4 class="c-grey-900 mB-20">Update Blog</h4>
                      <div class="send-header">
                        ...
                        <div class="form-group">
                          <img src="{{ url('/thumbnail/') }}/{{ $record->blog_image }}" width="100px;" height="100px;"></td>
                        </div>
                        <hr>
                      ...
                      <hr>
                      <input class="trending" type="checkbox" <?php if(isset($record->trending) && $record->trending ==1 ){ echo "checked"; } ?> name="trending" value="1" /> Trending
                      <hr>

                      <input class="latest" type="checkbox" <?php if(isset($record->latest) && $record->latest ==1 ){ echo "checked"; } ?> name="latest" value="1" /> Latest
